...
export const ProofUploadCard: React.FC<ProofUploadCardProps> = ({ onFileSelect }) => {
    ...
    return (
        <div className="bg-white dark:bg-surface-dark rounded-xl p-6 shadow-sm border border-divider dark:border-primary/20 flex flex-col h-auto">
            <div className="flex items-center gap-2 mb-4">
                <div className="p-2 bg-purple-50 dark:bg-purple-900/20 rounded-lg text-purple-600">
                    <Icon name="add_a_photo" />
                </div>
                <div>
                    <h3 className="text-lg font-bold text-body dark:text-body">Proof of Work</h3>
                    <p className="text-xs text-subtle dark:text-gray-400">Required for remote login</p>
                </div>
            </div>
            ...
            {preview ? (
                ...
                <div
                    ...
                    className={`flex-1 border-2 border-dashed rounded-lg p-6 flex flex-col items-center justify-center text-center cursor-pointer transition-colors ${isDragging
                        ...
                        : 'border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-primary/10'
                        }`}
                >
                    ...
                    <p className="text-sm font-medium text-body dark:text-body mb-1">
                        Click to upload or drag & drop
                    </p>
                    <p className="text-xs text-subtle dark:text-gray-400">SVG, PNG, JPG (max 2MB)</p>
                </div>
            )}
