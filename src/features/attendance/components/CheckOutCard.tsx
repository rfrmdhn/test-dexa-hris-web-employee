...
export const CheckOutCard: React.FC<CheckOutCardProps> = ({ onCheckOut, isCheckingOut }) => {
    return (
        <Card className="mt-4 p-4">
            <h3 className="text-lg font-bold mb-2 text-body dark:text-body">Actions</h3>
            <p className="text-sm text-subtle mb-4">You are currently clocked in. Don't forget to check out when you finish!</p>
